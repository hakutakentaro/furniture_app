...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { put_depth: @area.put_depth, put_width: @area.put_width } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { put_depth: @area.put_depth, put_width: @area.put_width } }
