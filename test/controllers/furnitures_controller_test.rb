...
class FurnituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create furniture" do
    assert_difference('Furniture.count') do
      post furnitures_url, params: { furniture: { furniture_depth: @furniture.furniture_depth, furniture_image: @furniture.furniture_image, furniture_name: @furniture.furniture_name, furniture_width: @furniture.furniture_width } }
    end
  ...
  test "should update furniture" do
    patch furniture_url(@furniture), params: { furniture: { furniture_depth: @furniture.furniture_depth, furniture_image: @furniture.furniture_image, furniture_name: @furniture.furniture_name, furniture_width: @furniture.furniture_width } }
